...
def initialize_parameters():
    ...
    x2_encoder_h5 = tf.get_variable("x2_encoder_h5", [128,15], initializer = tf.keras.initializers.VarianceScaling(seed=1))
...
def train_mynetwork(x1_train_set, x1_test_set, y_train_set, y_test_set,
    ...
    with tf.Session() as sess:
        ...
        print("save model")
        os.makedirs(os.path.dirname("./save_LiDAR/model.ckpt"), exist_ok=True)
        save_path = saver.save(sess,"./save_LiDAR/model.ckpt")
