...
def initialize_parameters():
    ...
    x1_encoder_h1 = tf.get_variable("x1_encoder_h1", [165,16], initializer = tf.keras.initializers.VarianceScaling(seed=1))
    ...
    x1_encoder_h7 = tf.get_variable("x1_encoder_h7", [64,15], initializer = tf.keras.initializers.VarianceScaling(seed=1))
...
def train_mynetwork(x1_train_set, x1_test_set, y_train_set, y_test_set, MODEL,
    ...
    with tf.Session() as sess:
        ...
        print("save model")
        os.makedirs(os.path.dirname("./save_Early_FC/model.ckpt"), exist_ok=True)
        save_path = saver.save(sess,"./save_Early_FC/model.ckpt")
