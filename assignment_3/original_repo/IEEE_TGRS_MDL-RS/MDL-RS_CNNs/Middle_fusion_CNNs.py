...
def initialize_parameters():
    ...
    x1_conv_w4 = tf.get_variable("x1_conv_w4", [1,1,256,128], initializer = tf.keras.initializers.VarianceScaling(seed=1))
    ...
    x1_conv_w6 = tf.get_variable("x1_conv_w6", [1,1,64,15], initializer = tf.keras.initializers.VarianceScaling(seed=1))
...
def train_mynetwork(x1_train_set, x2_train_set, x1_test_set, x2_test_set, y_train_set, y_test_set, MODEL,
    ...
    with tf.Session() as sess:
        ...
        print("save model")
        os.makedirs(os.path.dirname("./save_CNN_Middle/model.ckpt"), exist_ok=True)
        save_path = saver.save(sess,"./save_CNN_Middle/model.ckpt")
